...
vivt_hist = glob.glob(str(sys.argv[2])) # imput need to be like "path/vivt_*_01.nc" for exemple
...
for f in vivt_hist:
    ...
    if i == 0:
        ...
        perc_all_sim = perc_all_sim + perc
    i+=1

perc = perc_all_sim / i # 98th ensemble mean
